      ...
      <div class="box">
        ...
        <div class="right-box" v-for="item in shop_list" :key="item">
          <div id="date">
           ...
           <div>
             <input type="date" v-model="date" placeholder="日付を選択"/>
           </div>
           <select class="time" required type="time" v-model="time">
            <option value=""
                    hidden>時間を選択</option>
          ...
          <select class="num" required type="text" v-model="text">
            <option value=""
                    hidden>人数を選択</option>
